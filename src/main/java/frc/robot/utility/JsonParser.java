...
public class JsonParser {
    ...
    private static SwerveDriveSubsystem swerveSubsystem;
    private static JSONObject jsonObject;
    private static JSONArray jsonArray;

    public static void JsonParser(IntakeSubsystem intakeSubsystem, TransferSubsystem transferSubsystem, ShooterSubsystem shooterSubsystem, SwerveDriveSubsystem swerveSubsystem){

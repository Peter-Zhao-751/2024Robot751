...
public class Move extends Command {
    ...
    public Move(SwerveDriveSubsystem s_Swerve, Pose2d desiredLocation, List<Translation2d> interiorWaypoints) {
    ...
    public Move(SwerveDriveSubsystem s_Swerve, Pose2d desiredLocation) {
        this(s_Swerve, desiredLocation, List.of());
        addRequirements(s_Swerve);
    }

    public Move(SwerveDriveSubsystem s_Swerve, Trajectory trajectory) {
        this.s_Swerve = s_Swerve;
